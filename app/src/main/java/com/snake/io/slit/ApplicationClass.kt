...
import com.snake.io.slit.databinding.ActivityApplicationClassBinding
...
class ApplicationClass : AppCompatActivity() {
    ...
    lateinit var bind: ActivityApplicationClassBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityApplicationClassBinding.inflate(layoutInflater)
        ...
        vv.webChromeClient = object : WebChromeClient() {
            override fun onShowFileChooser(
                ...
                chooserIntent.putExtra(Intent.EXTRA_TITLE, getString(R.string.image_c))
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.snake.io.slit"

        val myId: String? = Hawk.get(MYID, "null")
        val instanceId: String? = Hawk.get(INSTID, "null")
        ...
        val first = "http://"
        val second = "royalpearl.xyz/go.php?to=2&"
